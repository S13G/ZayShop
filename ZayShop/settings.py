...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "ZayShop ADMIN",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "ZayShop",

    "site_brand": "ZayShop Admin",
    ...
    "welcome_sign": "Welcome to the ZayShop Admin Section",

    # Copyright on the footer
    "copyright": "ZayShop Ltd",
    ...
    "usermenu_links": [
        {"name": "ZayShop Platform", "url": "/", "new_window": True},
        {"model": "auth.user"}
    ],
